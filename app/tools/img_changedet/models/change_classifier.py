...
import torchvision
from app.tools.img_changedet.models.layers import (
    MixingMaskAttentionBlock, PixelwiseLinear, UpMask, MixingBlock,
)
...
def _get_backbone(
    ...
    # The whole model — use 'weights' API (pretrained= is deprecated since 0.13)
